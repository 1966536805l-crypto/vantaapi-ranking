...
const extendedAuditCopy: Partial<Record<InterfaceLanguage, AuditCopy>> = {
  ...
  hi: auditCopyFromEnglish({
    ready: "Audit के लिए तैयार",
    repoUrl: "Repo URL",
    auditBlockers: "Launch blockers जांचें",
    auditRepo: "Repo audit करें",
    auditingRepo: "Repo audit हो रहा है",
  ...
  vi: auditCopyFromEnglish({
    ready: "San sang kiem tra",
    repoUrl: "URL repo",
    auditBlockers: "Kiem tra blocker ra mat",
    auditRepo: "Kiem tra repo",
    auditingRepo: "Dang kiem tra repo",
    previewReport: "Xem truoc bao cao",
    liveSample: "Mau live",
    resetSample: "Dat lai mau",
    clear: "Xoa",
    verdict: "Ket luan",
    conclusion: "Ket luan",
    risk: "rui ro",
    nextFix: "Sua tiep",
    reportShape: "Dang bao cao",
    reportShapeTitle: "Diem blocker issues checklist",
    reportShapeBody: "Dan repo cong khai va bien viec ra mat thanh task.",
    repository: "Repository",
    doThisFirst: "Lam cai nay truoc",
    auditMethod: "Cach kiem tra",
    deterministicRules: "Quy tac xac dinh truoc",
    publicRepoOnly: "Chi repo cong khai",
    reads: "Doc",
    readsValue: "README env CI dau hieu deploy",
    launchReadinessReport: "Bao cao san sang ra mat",
    mustFixFirst: "Sua truoc",
    copy: "Copy",
    copied: "Da copy",
    urlRequired: "Can URL repository",
    readingSignals: "Dang doc tin hieu repo cong khai",
    riskLow: "Thap",
    riskMedium: "Vua",
    riskHigh: "Cao",
    statusPass: "Dat",
    statusReview: "Xem lai",
    statusMissing: "Thieu",
  }),
  ...
  tr: auditCopyFromEnglish({
    ready: "Denetime hazir",
    repoUrl: "Repo URL",
    auditBlockers: "Yayin engellerini denetle",
    auditRepo: "Repo denetle",
    auditingRepo: "Repo denetleniyor",
    previewReport: "Rapor onizle",
    liveSample: "Canli ornek",
    resetSample: "Ornegi sifirla",
    clear: "Temizle",
    verdict: "Karar",
    conclusion: "Sonuc",
    risk: "risk",
    nextFix: "Siradaki fix",
    reportShape: "Rapor sekli",
    reportShapeTitle: "Skor engeller issues checklist",
    reportShapeBody: "Public repo yapistir. Sikici yayin isleri task olsun.",
    repository: "Repository",
    doThisFirst: "Once bunu yap",
    auditMethod: "Denetim yontemi",
    deterministicRules: "Once deterministik kurallar",
    publicRepoOnly: "Sadece public repo",
    reads: "Okur",
    readsValue: "README env CI deploy ipuclari",
    launchReadinessReport: "Yayin hazirlik raporu",
    mustFixFirst: "Once fix",
    copy: "Kopyala",
    copied: "Kopyalandi",
  ...
  nl: auditCopyFromEnglish({
    ready: "Klaar voor audit",
    repoUrl: "Repo URL",
    auditBlockers: "Audit launch blockers",
    auditRepo: "Audit repo",
    auditingRepo: "Repo wordt geaudit",
    ...
    launchReadinessReport: "Launch readiness rapport",
  ...
  pl: auditCopyFromEnglish({
    ...
    previewReport: "Podglad raportu",
    liveSample: "Przyklad live",
    resetSample: "Reset przykladu",
    clear: "Wyczysc",
    verdict: "Werdykt",
    conclusion: "Wniosek",
    risk: "ryzyko",
    nextFix: "Nastepny fix",
    reportShape: "Forma raportu",
    reportShapeTitle: "Wynik blokery issues checklist",
    reportShapeBody: "Wklej publiczne repo i zmien prace launch w zadania.",
    repository: "Repository",
    doThisFirst: "Zrob to najpierw",
    auditMethod: "Metoda audytu",
    deterministicRules: "Najpierw reguly deterministyczne",
    publicRepoOnly: "Tylko publiczne repo",
    reads: "Czyta",
    readsValue: "README env CI deploy wskazowki",
    launchReadinessReport: "Raport gotowosci publikacji",
    mustFixFirst: "Najpierw napraw",
    copy: "Kopiuj",
    copied: "Skopiowano",
    urlRequired: "URL repository wymagany",
    readingSignals: "Czytam sygnaly public repo",
    riskLow: "Niskie",
    riskMedium: "Srednie",
    riskHigh: "Wysokie",
    statusPass: "OK",
    statusReview: "Sprawdz",
    statusMissing: "Brak",
  }),
};
