...
const searchResultCopy: Record<InterfaceLanguage, DisplaySearchCopy> = {
  en: {
    ...
    toolTitles: {
      ...
      "learning-roadmap": "KI Coding Roadmap",
    },
    toolDescriptions: {
  ...
  de: {
    categories: { start: "Start", tools: "KI Werkzeuge", coding: "Programmierlabor" },
    staticItems: {
      "/search": { title: "Seitensuche", description: "Werkzeuge Lernwege und Launch Checklisten in einem Feld finden" },
      "/tools/github-repo-analyzer": { title: "GitHub Startpruefung", description: "Oeffentliches Repo einfuegen und Blocker Score Checkliste erhalten" },
      "/programming": { title: "Programmier Lernlabor", description: "Einsteigerpfade fuer echte Entwicklersprachen" },
    },
    toolTitles: {
      "github-repo-analyzer": "GitHub Startpruefung",
      "prompt-optimizer": "KI Prompt Optimierer",
    ...
    toolDescriptions: {
      ...
      "prompt-optimizer": "Grobe Anfragen in klare KI Prompts verwandeln",
  ...
  hi: {
    categories: { start: "शुरुआत", tools: "AI उपकरण", coding: "कोडिंग लैब" },
    staticItems: {
      "/search": { title: "साइट खोज", description: "उपकरण रास्ते और लॉन्च चेकलिस्ट एक जगह खोजें" },
      "/tools/github-repo-analyzer": { title: "GitHub लॉन्च जांच", description: "सार्वजनिक repo चिपकाकर blocker score और checklist पाएं" },
      "/programming": { title: "प्रोग्रामिंग सीखने की लैब", description: "शून्य आधार से developer languages सीखने के रास्ते" },
    },
    toolTitles: {
      ...
      "bug-finder": "bug खोजक",
      "api-request-generator": "API request generator",
      "dev-utilities": "JSON regex समय उपकरण",
    ...
    programmingLanguageTitle: (name) => `${name} सीखने की लैब`,
    programmingLanguageDescription: (name) => `${name} की परिभाषा syntax अभ्यास और practice route`,
  },
  id: {
  ...
  vi: {
    categories: { start: "Bắt đầu", tools: "Công cụ AI", coding: "Phòng lab code" },
    staticItems: {
      "/search": { title: "Tìm kiếm site", description: "Tìm công cụ lộ trình và checklist phát hành trong một ô" },
      "/tools/github-repo-analyzer": { title: "Kiểm tra ra mắt GitHub", description: "Dán repo công khai để có điểm blocker và checklist" },
      "/programming": { title: "Lab học lập trình", description: "Lộ trình từ con số 0 cho ngôn ngữ developer" },
    },
    toolTitles: {
    ...
    programmingLanguageTitle: (name) => `Lab ${name}`,
    programmingLanguageDescription: (name) => `Định nghĩa cú pháp bài tập và lộ trình cho ${name}`,
  },
  th: {
  ...
  tr: {
    categories: { start: "Başlangıç", tools: "AI araçları", coding: "Kod laboratuvarı" },
    staticItems: {
      "/search": { title: "Site arama", description: "Araçları rotaları ve yayın checklistlerini tek kutuda bul" },
      "/tools/github-repo-analyzer": { title: "GitHub yayın denetimi", description: "Public repo yapıştır blocker skor ve checklist al" },
      "/programming": { title: "Programlama öğrenme lab", description: "Sıfırdan developer dilleri için rotalar" },
    },
    toolTitles: {
    ...
    programmingLanguageDescription: (name) => `${name} için tanımlar söz dizimi alıştırma ve rota`,
  },
  it: {
  ...
  nl: {
    categories: { start: "Start", tools: "AI gereedschap", coding: "Programmeerlab" },
    staticItems: {
      "/search": { title: "Site zoeken", description: "Vind tools routes en launch checklists vanuit een zoekvak" },
      "/tools/github-repo-analyzer": { title: "GitHub publicatiecontrole", description: "Plak een publiek repo en krijg blockers score en checklist" },
  ...
  pl: {
    ...
    staticItems: {
      "/search": { title: "Wyszukiwanie", description: "Znajdź narzędzia ścieżki i checklisty publikacji w jednym polu" },
      "/tools/github-repo-analyzer": { title: "Audyt publikacji GitHub", description: "Wklej publiczne repo aby dostać blokery score i checklist" },
      "/programming": { title: "Lab nauki programowania", description: "Ścieżki od zera dla języków developerów" },
    },
    toolTitles: {
    ...
    programmingLanguageTitle: (name) => `Lab ${name}`,
    programmingLanguageDescription: (name) => `Definicje składnia ćwiczenia i trasa praktyki dla ${name}`,
  },
};
