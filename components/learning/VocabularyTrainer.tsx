...
const copy = {
  en: {
    ...
    audioPolicy: "JinMing Memory Voice is a self-made pronunciation routine: normal sound slow imprint spelling echo and final recall. No dictionary audio or third party human recordings are fetched.",
    ...
    realAudio: "JinMing Memory Voice",
    fallbackAudio: "JinMing Memory Voice",
  ...
  zh: {
    ...
    question: "选择最接近的意思",
    pronunciation: "记忆发音",
    audioPolicy: "JinMing Memory Voice 是站内自制发音节奏 正常音 慢速强化 拼写回声 最后巩固 不抓取第三方词典音频 不使用真人录音素材",
    loadingAudio: "加载中",
    know: "认识",
    unknown: "不认识",
    next: "下一个",
