...
const quickLanguageByUi: Record<string, InterfaceLanguage> = {
  english: "en",
  chinese: "zh",
  japanese: "ja",
  korean: "ko",
...
const quickActions: Record<string, QuickAction[]> = {
  ...
  japanese: [
    ...
    { id: "quick:wordbook", title: "単語帳", label: "単語帳を開く", href: "/english/vocabulary/custom", kind: "english", body: "自分の単語を入れてタグを付けて直接練習します" },
    ...
    { id: "quick:english:typing", title: "英語タイピング", label: "タイピング開始", href: "/english/typing", kind: "english", body: "音を聞いて単語と文を正しく入力します" },
  ...
  korean: [
    ...
    { id: "quick:wordbook", title: "내 단어장", label: "단어장 열기", href: "/english/vocabulary/custom", kind: "english", body: "내 단어를 가져오고 태그를 붙여 바로 훈련합니다" },
    ...
    { id: "quick:english:typing", title: "영어 타이핑", label: "타이핑 시작", href: "/english/typing", kind: "english", body: "소리를 듣고 단어와 문장을 정확히 입력합니다" },
  ...
  spanish: [
    ...
    { id: "quick:wordbook", title: "Mi vocabulario", label: "Abrir vocabulario", href: "/english/vocabulary/custom", kind: "english", body: "Importa tus palabras añade etiquetas y entrena directo." },
    ...
    { id: "quick:english:typing", title: "Typing inglés", label: "Iniciar typing", href: "/english/typing", kind: "english", body: "Escucha y escribe palabras y frases hasta acertar." },
  ...
  french: [
    ...
    { id: "quick:wordbook", title: "Mon lexique", label: "Ouvrir lexique", href: "/english/vocabulary/custom", kind: "english", body: "Importer vos mots ajouter des tags et entraîner directement." },
    ...
    { id: "quick:english:typing", title: "Typing anglais", label: "Lancer typing", href: "/english/typing", kind: "english", body: "Écouter puis taper mots et phrases jusqu à réussir." },
...
export default function QuickStartPanel({ ui = "english" }: { ui?: string }) {
  ...
  function recordStart(action: QuickAction, href: string) {
    recordLocalActivity({
      id: action.id,
      title: action.title,
      href,
    ...
    <section className="mt-3 grid gap-3 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
      <div className="dense-panel p-5">
        <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
          ...
          {continueItem ? (
            <Link href={localizedHref(continueItem.href, language)} className="dense-action-primary">
              {copy.continue}
            </Link>
          ) : (
            <Link href={localizedHref("/search", language)} className="dense-action-primary">
              {copy.searchFirst}
            </Link>
          )}
        </div>
        ...
        <div className="mt-4 grid gap-2">
          {summary.recents.length > 0 ? (
            summary.recents.slice(0, 4).map((item) => (
              <Link key={`${item.id}-${item.ts}`} href={localizedHref(item.href, language)} className="rounded-[8px] border border-white/10 bg-white/[0.07] p-3 text-white transition hover:border-sky-200/50">
