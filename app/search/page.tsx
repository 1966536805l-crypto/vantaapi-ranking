...
const searchCopy: Partial<Record<InterfaceLanguage, SearchCopy>> & { en: SearchCopy; zh: SearchCopy } = {
  ...
  hi: {
    ...
    body: "GitHub जांच, Prompt, Bug, API, developer उपकरण और programming routes पर केंद्रित खोज।",
    placeholder: "GitHub prompt bug api json python खोजें",
    search: "खोजें",
    index: "इंडेक्स",
    entries: "सार्वजनिक प्रवेश",
    fastStart: "तेज शुरुआत",
    runAudit: "GitHub जांच चलाएं",
  ...
  vi: {
    ...
    tools: "Công cụ AI",
    coding: "Lập trình",
    eyebrow: "Tìm công cụ lập trình",
    title: "Tìm kiểm tra ra mắt công cụ AI và lộ trình lập trình",
    body: "Tìm trong kiểm tra GitHub, prompt, bug, API, tiện ích lập trình và lộ trình lập trình.",
    placeholder: "Tìm GitHub prompt bug api json python",
    search: "Tìm",
    index: "Chỉ mục",
    entries: "mục công khai",
    fastStart: "Bắt đầu nhanh",
    runAudit: "Chạy kiểm tra GitHub",
  ...
  th: {
    ...
    body: "ค้นหา ตรวจ GitHub, prompt, bug, API, เครื่องมือนักพัฒนา และเส้นทางเขียนโปรแกรม",
    placeholder: "ค้นหา GitHub prompt bug api json python",
    search: "ค้นหา",
    index: "ดัชนี",
    entries: "รายการสาธารณะ",
    fastStart: "เริ่มเร็ว",
    runAudit: "รันตรวจ GitHub",
  ...
  tr: {
    ...
    body: "GitHub denetimi, prompt, bug, API, geliştirici araçları ve programlama yollarına odaklı arama.",
    placeholder: "GitHub prompt bug api json python ara",
    search: "Ara",
    index: "Dizin",
    entries: "açık girişler",
    fastStart: "Hızlı başla",
    runAudit: "GitHub denetimi çalıştır",
    ...
    open: "Aç",
    categories: { Start: "Başlangıç", "AI Tools": "AI araçları", "Coding Lab": "Kod laboratuvarı" },
  },
  it: {
  ...
  nl: {
    ...
    body: "Zoeken in GitHub controles, prompts, bugs, API, developerhulpmiddelen en programmeerroutes.",
  ...
  pl: {
    ...
    body: "Wyszukiwanie skupia się na audycie GitHub, prompt, bug, API, narzędziach deweloperskich i ścieżkach programowania.",
    placeholder: "Szukaj GitHub prompt bug api json python",
    search: "Szukaj",
    index: "Indeks",
    entries: "publicznych wejść",
    fastStart: "Szybki start",
    runAudit: "Uruchom audyt GitHub",
...
const searchResultDisplayCopy: Record<InterfaceLanguage, SearchResultDisplayCopy> = {
  ...
  hi: {
    staticItems: {
      "/search": { title: "साइट खोज", description: "उपकरण रास्ते और लॉन्च checklist एक जगह खोजें", tags: ["खोज", "सूचकांक"] },
      "/tools/github-repo-analyzer": { title: "GitHub लॉन्च जांच", description: "सार्वजनिक repo चिपकाकर blockers score और checklist पाएं", tags: ["GitHub", "लॉन्च"] },
      "/programming": { title: "प्रोग्रामिंग सीखने की लैब", description: "शून्य आधार से developer languages सीखने के रास्ते", tags: ["अभ्यास", "शून्य"] },
    },
    toolTitles: {
      "github-repo-analyzer": "GitHub लॉन्च जांच",
      "prompt-optimizer": "AI prompt सुधारक",
      "code-explainer": "code समझाने वाला",
      "bug-finder": "bug खोजक",
      "api-request-generator": "API request generator",
      "dev-utilities": "JSON regex time tools",
      "learning-roadmap": "AI कोडिंग रोडमैप",
    },
    toolDescriptions: {
      "github-repo-analyzer": "सार्वजनिक repos को launch blockers के लिए जांचें",
      "prompt-optimizer": "कच्चे अनुरोध को साफ AI prompt बनाएं",
      "code-explainer": "code का उद्देश्य जोखिम और notes जल्दी समझें",
      "bug-finder": "error और snippet से debug steps बनाएं",
      ...
      "learning-roadmap": "शून्य से practical coding plan बनाएं",
    },
    programmingTitle: (name) => `${name} सीखने की लैब`,
    programmingDescription: (name) => `${name} की परिभाषा syntax अभ्यास और practice route`,
    programmingTag: "अभ्यास",
  },
  id: {
    staticItems: {
  ...
  vi: {
    staticItems: {
      "/search": { title: "Tìm kiếm site", description: "Tìm công cụ lộ trình và checklist phát hành trong một ô", tags: ["tìm", "chỉ mục"] },
      "/tools/github-repo-analyzer": { title: "Kiểm tra ra mắt GitHub", description: "Dán repo công khai để có điểm blocker và checklist", tags: ["GitHub", "ra mắt"] },
      "/programming": { title: "Lab học lập trình", description: "Lộ trình từ con số 0 cho ngôn ngữ developer", tags: ["thực hành", "cơ bản"] },
    },
    toolTitles: {
      "github-repo-analyzer": "Kiểm tra ra mắt GitHub",
      "prompt-optimizer": "Tối ưu prompt AI",
      "code-explainer": "Giải thích code",
      "bug-finder": "Tìm bug",
      "api-request-generator": "Tạo request API",
      "dev-utilities": "Công cụ JSON Regex Thời gian",
      "learning-roadmap": "Lộ trình code AI",
    },
    toolDescriptions: {
      "github-repo-analyzer": "Kiểm tra repo công khai trước khi ra mắt",
      "prompt-optimizer": "Biến yêu cầu thô thành prompt rõ ràng",
      "code-explainer": "Đọc code với mục đích rủi ro và ghi chú",
      "bug-finder": "Biến lỗi và snippet thành bước debug",
      "api-request-generator": "Tạo curl fetch axios và Python requests",
      "dev-utilities": "Format JSON test regex đổi timestamp",
      "learning-roadmap": "Tạo kế hoạch học code từ số 0",
    },
    programmingTitle: (name) => `Lab ${name}`,
    programmingDescription: (name) => `Định nghĩa cú pháp bài tập và lộ trình cho ${name}`,
    programmingTag: "thực hành",
  },
  th: {
    staticItems: {
  ...
  tr: {
    staticItems: {
      "/search": { title: "Site arama", description: "Araçları rotaları ve yayın checklistlerini tek kutuda bul", tags: ["arama", "dizin"] },
      "/tools/github-repo-analyzer": { title: "GitHub yayın denetimi", description: "Public repo yapıştır blocker skor ve checklist al", tags: ["GitHub", "yayın"] },
      "/programming": { title: "Programlama öğrenme lab", description: "Sıfırdan developer dilleri için rotalar", tags: ["pratik", "sıfır"] },
    },
    toolTitles: {
      "github-repo-analyzer": "GitHub yayın denetimi",
      "prompt-optimizer": "AI prompt iyileştirici",
      "code-explainer": "Kod açıklayıcı",
      "bug-finder": "Bug bulucu",
      "api-request-generator": "API request oluşturucu",
      "dev-utilities": "JSON Regex Zaman araçları",
      "learning-roadmap": "AI kod roadmap",
    },
    toolDescriptions: {
      "github-repo-analyzer": "Public repoları yayın blocker için denetler",
      "prompt-optimizer": "Kaba isteği net AI prompt haline getirir",
      "code-explainer": "Kodu amaç risk ve notlarla okur",
      "bug-finder": "Hata ve snippetten debug adımları çıkarır",
      "api-request-generator": "curl fetch axios ve Python requests üretir",
      "dev-utilities": "JSON formatlar regex test eder timestamp cevirir",
      "learning-roadmap": "Sıfırdan pratik kod planı oluşturur",
    },
    programmingTitle: (name) => `${name} lab`,
    programmingDescription: (name) => `${name} için tanımlar söz dizimi alıştırma ve rota`,
  ...
  nl: {
    staticItems: {
      ...
      "/tools/github-repo-analyzer": { title: "GitHub publicatiecontrole", description: "Plak een publiek repo en krijg blockers score en checklist", tags: ["GitHub", "publicatie"] },
      "/programming": { title: "Programmeer leerlab", description: "Nul basis routes voor talen van developers", tags: ["praktijk", "basis"] },
    },
    toolTitles: {
      "github-repo-analyzer": "GitHub publicatiecontrole",
      "prompt-optimizer": "AI prompt verbeteraar",
  ...
  pl: {
    staticItems: {
      "/search": { title: "Wyszukiwanie", description: "Znajdź narzędzia ścieżki i checklisty publikacji w jednym polu", tags: ["szukaj", "indeks"] },
      "/tools/github-repo-analyzer": { title: "Audyt publikacji GitHub", description: "Wklej publiczne repo aby dostać blokery score i checklist", tags: ["GitHub", "publikacja"] },
      "/programming": { title: "Lab nauki programowania", description: "Ścieżki od zera dla języków developerów", tags: ["praktyka", "od zera"] },
    },
    toolTitles: {
      "github-repo-analyzer": "Audyt publikacji GitHub",
      "prompt-optimizer": "Optymalizator prompt AI",
      "code-explainer": "Wyjaśniacz kodu",
      "bug-finder": "Wyszukiwacz bugów",
      "api-request-generator": "Generator requestów API",
      "dev-utilities": "Narzędzia JSON Regex Czas",
      "learning-roadmap": "Roadmap kodowania AI",
    },
    toolDescriptions: {
      "github-repo-analyzer": "Sprawdza publiczne repo przed publikacją",
      "prompt-optimizer": "Zmienia surowe prośby w jasne prompty",
    ...
    programmingTitle: (name) => `Lab ${name}`,
    programmingDescription: (name) => `Definicje składnia ćwiczenia i trasa praktyki dla ${name}`,
