...
const copy = {
  en: {
    ...
    sections: [
      ["Data", "The site stores learning records, project notes, mistakes and status logs that you save"],
      ["Use", "Data is used to provide the study tools and prevent abuse"],
  ...
  zh: {
    ...
    sections: [
      ["数据", "网站会保存你主动记录的学习记录、项目笔记、错题和状态日志"],
      ["用途", "数据用于提供学习工具功能，并防止滥用"],
