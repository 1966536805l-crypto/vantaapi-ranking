...
const modules: Record<SiteLanguage, Parameters<typeof ModuleHub>[0]["modules"]> = {
  en: [
    ...
    { href: "/cpp/quiz/mega-1000", eyebrow: "Mega Bank", title: cppQuestionBank.title, description: "8 categories · 125 questions each · Syntax · Control flow · Arrays/strings · Pointers/references · OOP · STL · Algorithms · Output prediction", points: cppQuestionBank.categoryPlan.map((item) => item.title) },
  ],
  zh: [
    ...
    { href: "/cpp/quiz/mega-1000", eyebrow: "千题库", title: "C++ 1000 题库", description: "8 个分类 · 每类 125 题 · 语法 · 控制流 · 数组字符串 · 指针引用 · OOP · STL · 算法 · 输出预测", points: cppQuestionBank.categoryPlan.map((item) => item.zh) },
  ],
};
...
const copy = {
  en: {
    ...
    description: "1000-question bank · Code reading · Output prediction · Beginner algorithms · No online compiler in MVP",
    cta: "Open course path",
  },
  zh: {
    eyebrow: "C++ 学习",
    title: "C++ 题库训练中心",
    description: "1000 道题库 · 代码阅读 · 输出预测 · 基础算法 · MVP 暂不做在线编译器",
    cta: "打开学习路径",
  },
} as const;
