...
const zeroSteps = {
  en: [
    { key: "01", title: "Program", body: "A program is a set of exact instructions that turns input into output.", example: "input -> rules -> output" },
    { key: "02", title: "Output", body: "Printing a value is the first way to check that code is alive.", example: "print 42" },
    { key: "03", title: "Values", body: "Variables give names to numbers text booleans lists and objects.", example: "total = 42" },
    { key: "04", title: "Flow", body: "Branches choose a path and loops repeat useful work.", example: "if condition then repeat" },
...
const groups: Array<{
...
}> = [
  {
    ...
    zh: "网页和产品",
    summary: "Make pages tools APIs and product interfaces",
    summaryZh: "做网页 工具 API 和产品界面",
  ...
  },
  {
    ...
    zh: "后端和云服务",
    summary: "Build services databases CLIs and reliable APIs",
    summaryZh: "做服务 数据库 命令行和稳定 API",
  ...
  },
  {
    ...
    zh: "手机和应用",
    summary: "Build iOS Android and cross platform apps",
    summaryZh: "做 iOS Android 和跨端应用",
  ...
  },
  {
    ...
    zh: "系统和性能",
    summary: "Understand memory speed compilers and low level code",
    summaryZh: "理解内存 性能 编译器和底层代码",
  ...
  },
  {
    ...
    zh: "数据和科学计算",
    summary: "Analyze data model numbers and create research workflows",
    summaryZh: "分析数据 建模 处理数值和研究流程",
  ...
  },
  {
    ...
    zh: "函数式和语言设计",
    summary: "Learn types transformations concurrency and compiler thinking",
    summaryZh: "学习类型 转换 并发和编译器思维",
  ...
  },
  {
    ...
    zh: "脚本和自动化",
    summary: "Automate files text games plugins and daily workflows",
    summaryZh: "自动化文件 文本 游戏 插件和日常流程",
  ...
  },
  {
    ...
    zh: "合约和安全",
    summary: "Study state permissions transactions and secure code review",
    summaryZh: "学习状态 权限 交易和安全代码审查",
...
const copy = {
  en: {
    ...
    subtitle: "Start from shared programming ideas then choose one language and practice with structured original drills.",
  ...
  zh: {
    eyebrow: "0 基础编程",
    title: "编程语言训练实验室",
    subtitle: "先学编程语言共通的思想 再选一门语言进入原创练习和项目训练",
