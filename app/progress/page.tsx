        ...
        {items.length === 0 && (
          <div className="apple-card border-dashed p-7 text-center">
            ...
            <div className="mt-5 flex justify-center gap-3">
              <Link href={localizedHref("/english", language)} className="apple-button-primary px-4 py-2 text-sm">开始英语</Link>
              <Link href={localizedHref("/cpp", language)} className="apple-button-secondary px-4 py-2 text-sm">开始 C++</Link>
            </div>
          </div>
        )}
      </div>
