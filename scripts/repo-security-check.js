...
const requiredWorkflows = [
  [".github/workflows/security.yml", ["DATABASE_URL: \"postgresql://", "npm run security:check", "npm run security:supply-chain", "npm run security:secrets", "npm run build", "npm run language:smoke"]],
