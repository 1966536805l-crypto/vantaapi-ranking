...
expect("public questions API is scoped", includes("app/api/questions/route.ts", "lessonId is required") && includes("app/api/questions/route.ts", "isPublished: true") && matches("app/api/questions/route.ts", /MAX_LIMIT\s*=\s*25/) && matches("app/api/questions/route.ts", /publicQuestionSelect/) && !matches("app/api/questions/route.ts", /answer:\s*true/), "public questions must require lessonId, published lesson, low limit, and public field select");
