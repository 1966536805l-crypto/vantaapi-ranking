...
export const worldLanguageSurvivalPhrases: Partial<Record<string, Record<SurvivalPhraseKey, string>>> = {
  ...
  italian: {
    greeting: "Ciao",
    thanks: "Grazie",
    selfIntro: "Sto imparando l'italiano",
    need: "Vorrei dell'acqua",
    confusion: "Non capisco",
    repeat: "Per favore ripeti",
    direction: "Dov'è questo posto",
    price: "Quanto costa",
  },
  portuguese: {
    greeting: "Olá",
    thanks: "Obrigado",
    selfIntro: "Estou aprendendo português",
    need: "Quero água",
    confusion: "Não entendo",
    repeat: "Por favor repita",
    direction: "Onde fica este lugar",
    price: "Quanto custa",
  },
  dutch: {
    greeting: "Hallo",
    thanks: "Dank je",
    selfIntro: "Ik leer Nederlands",
    need: "Ik wil water",
    confusion: "Ik begrijp het niet",
    repeat: "Zeg het alstublieft nog een keer",
    direction: "Waar is deze plek",
    price: "Hoeveel kost het",
  },
  swedish: {
    greeting: "Hej",
    thanks: "Tack",
    selfIntro: "Jag lär mig svenska",
    need: "Jag vill ha vatten",
    confusion: "Jag förstår inte",
    repeat: "Säg det igen tack",
    direction: "Var är den här platsen",
    price: "Hur mycket kostar det",
  },
  norwegian: {
    greeting: "Hei",
    thanks: "Takk",
    selfIntro: "Jeg lærer norsk",
    need: "Jeg vil ha vann",
    confusion: "Jeg forstår ikke",
    repeat: "Kan du si det igjen",
    direction: "Hvor er dette stedet",
    price: "Hvor mye koster det",
  },
  danish: {
    greeting: "Hej",
    thanks: "Tak",
    selfIntro: "Jeg lærer dansk",
    need: "Jeg vil gerne have vand",
    confusion: "Jeg forstår ikke",
    repeat: "Sig det venligst igen",
    direction: "Hvor er dette sted",
    price: "Hvor meget koster det",
  },
  russian: {
    greeting: "Привет",
    thanks: "Спасибо",
    selfIntro: "Я учу русский",
    need: "Я хочу воды",
    confusion: "Я не понимаю",
    repeat: "Повторите пожалуйста",
    direction: "Где это место",
    price: "Сколько это стоит",
  },
  polish: {
    greeting: "Cześć",
    thanks: "Dziękuję",
    selfIntro: "Uczę się polskiego",
    need: "Chcę wody",
    confusion: "Nie rozumiem",
    repeat: "Proszę powtórzyć",
    direction: "Gdzie jest to miejsce",
    price: "Ile to kosztuje",
  },
  ukrainian: {
    greeting: "Привіт",
    thanks: "Дякую",
    selfIntro: "Я вивчаю українську",
    need: "Я хочу води",
    confusion: "Я не розумію",
    repeat: "Повторіть будь ласка",
    direction: "Де це місце",
    price: "Скільки це коштує",
  },
  greek: {
    greeting: "Γεια",
    thanks: "Ευχαριστώ",
    selfIntro: "Μαθαίνω ελληνικά",
    need: "Θέλω νερό",
    confusion: "Δεν καταλαβαίνω",
    repeat: "Παρακαλώ πείτε το ξανά",
    direction: "Πού είναι αυτό το μέρος",
    price: "Πόσο κοστίζει",
  },
  turkish: {
    greeting: "Merhaba",
    thanks: "Teşekkürler",
    selfIntro: "Türkçe öğreniyorum",
    need: "Su istiyorum",
    confusion: "Anlamıyorum",
    repeat: "Lütfen tekrar söyleyin",
    direction: "Burası neresi",
    price: "Ne kadar",
  },
  arabic: {
    greeting: "مرحبا",
    thanks: "شكرا",
    selfIntro: "أنا أتعلم العربية",
    need: "أريد ماء",
    confusion: "لا أفهم",
    repeat: "من فضلك قلها مرة أخرى",
    direction: "أين هذا المكان",
    price: "كم السعر",
  },
  hebrew: {
    greeting: "שלום",
    thanks: "תודה",
    selfIntro: "אני לומד עברית",
    need: "אני רוצה מים",
    confusion: "אני לא מבין",
    repeat: "בבקשה תגיד את זה שוב",
    direction: "איפה המקום הזה",
    price: "כמה זה עולה",
  },
  persian: {
    greeting: "سلام",
    thanks: "ممنون",
    selfIntro: "من فارسی یاد می‌گیرم",
    need: "من آب می‌خواهم",
    confusion: "نمی‌فهمم",
    repeat: "لطفا دوباره بگویید",
    direction: "اینجا کجاست",
    price: "قیمتش چقدر است",
  },
  hindi: {
    greeting: "नमस्ते",
    thanks: "धन्यवाद",
    selfIntro: "मैं हिंदी सीख रहा हूँ",
    need: "मुझे पानी चाहिए",
    confusion: "मैं नहीं समझता",
    repeat: "कृपया फिर से कहिए",
    direction: "यह जगह कहाँ है",
    price: "यह कितने का है",
  },
  urdu: {
    greeting: "سلام",
    thanks: "شکریہ",
    selfIntro: "میں اردو سیکھ رہا ہوں",
    need: "مجھے پانی چاہیے",
    confusion: "میں نہیں سمجھتا",
    repeat: "براہ کرم دوبارہ کہیں",
    direction: "یہ جگہ کہاں ہے",
    price: "یہ کتنے کا ہے",
  },
  bengali: {
    greeting: "নমস্কার",
    thanks: "ধন্যবাদ",
    selfIntro: "আমি বাংলা শিখছি",
    need: "আমার পানি চাই",
    confusion: "আমি বুঝতে পারছি না",
    repeat: "অনুগ্রহ করে আবার বলুন",
    direction: "এই জায়গাটি কোথায়",
    price: "এটার দাম কত",
  },
  punjabi: {
    greeting: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ",
    thanks: "ਧੰਨਵਾਦ",
    selfIntro: "ਮੈਂ ਪੰਜਾਬੀ ਸਿੱਖ ਰਿਹਾ ਹਾਂ",
    need: "ਮੈਨੂੰ ਪਾਣੀ ਚਾਹੀਦਾ ਹੈ",
    confusion: "ਮੈਨੂੰ ਸਮਝ ਨਹੀਂ ਆਈ",
    repeat: "ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕਹੋ",
    direction: "ਇਹ ਥਾਂ ਕਿੱਥੇ ਹੈ",
    price: "ਇਹ ਕਿੰਨੇ ਦਾ ਹੈ",
  },
  tamil: {
    greeting: "வணக்கம்",
    thanks: "நன்றி",
    selfIntro: "நான் தமிழ் கற்கிறேன்",
    need: "எனக்கு தண்ணீர் வேண்டும்",
    confusion: "எனக்கு புரியவில்லை",
    repeat: "தயவுசெய்து மீண்டும் சொல்லுங்கள்",
    direction: "இந்த இடம் எங்கே",
    price: "இதன் விலை எவ்வளவு",
  },
  telugu: {
    greeting: "నమస్తే",
    thanks: "ధన్యవాదాలు",
    selfIntro: "నేను తెలుగు నేర్చుకుంటున్నాను",
    need: "నాకు నీళ్లు కావాలి",
    confusion: "నాకు అర్థం కాలేదు",
    repeat: "దయచేసి మళ్లీ చెప్పండి",
    direction: "ఈ స్థలం ఎక్కడ ఉంది",
    price: "దీని ధర ఎంత",
  },
  vietnamese: {
    greeting: "Xin chào",
    thanks: "Cảm ơn",
    selfIntro: "Tôi đang học tiếng Việt",
    need: "Tôi muốn nước",
    confusion: "Tôi không hiểu",
    repeat: "Vui lòng nói lại",
    direction: "Nơi này ở đâu",
    price: "Bao nhiêu tiền",
  },
  thai: {
    greeting: "สวัสดี",
    thanks: "ขอบคุณ",
    selfIntro: "ฉันกำลังเรียนภาษาไทย",
    need: "ฉันต้องการน้ำ",
    confusion: "ฉันไม่เข้าใจ",
    repeat: "กรุณาพูดอีกครั้ง",
    direction: "ที่นี่คือที่ไหน",
    price: "ราคาเท่าไหร่",
  },
  indonesian: {
    greeting: "Halo",
    thanks: "Terima kasih",
    selfIntro: "Saya belajar bahasa Indonesia",
    need: "Saya ingin air",
    confusion: "Saya tidak mengerti",
    repeat: "Tolong ulangi",
    direction: "Di mana tempat ini",
    price: "Berapa harganya",
  },
  malay: {
    greeting: "Halo",
    thanks: "Terima kasih",
    selfIntro: "Saya belajar bahasa Melayu",
    need: "Saya mahu air",
    confusion: "Saya tidak faham",
    repeat: "Sila ulang sekali lagi",
    direction: "Di mana tempat ini",
    price: "Berapa harganya",
  },
  tagalog: {
    greeting: "Kumusta",
    thanks: "Salamat",
    selfIntro: "Nag-aaral ako ng Tagalog",
    need: "Gusto ko ng tubig",
    confusion: "Hindi ko naiintindihan",
    repeat: "Pakisabi ulit",
    direction: "Nasaan ang lugar na ito",
    price: "Magkano ito",
  },
  swahili: {
    greeting: "Jambo",
    thanks: "Asante",
    selfIntro: "Ninajifunza Kiswahili",
    need: "Ninataka maji",
    confusion: "Sielewi",
    repeat: "Tafadhali sema tena",
    direction: "Mahali hapa ni wapi",
    price: "Ni bei gani",
  },
  amharic: {
    greeting: "ሰላም",
    thanks: "አመሰግናለሁ",
    selfIntro: "አማርኛ እማራለሁ",
    need: "ውሃ እፈልጋለሁ",
    confusion: "አልገባኝም",
    repeat: "እባክዎ እንደገና ይበሉ",
    direction: "ይህ ቦታ የት ነው",
    price: "ዋጋው ስንት ነው",
  },
  yoruba: {
    greeting: "Ẹ n lẹ",
    thanks: "Ẹ ṣé",
    selfIntro: "Mo ń kọ́ Yorùbá",
    need: "Mo fẹ́ omi",
    confusion: "Mi ò ye mi",
    repeat: "Jọwọ sọ lẹ́ẹ̀kan síi",
    direction: "Níbo ni ibi yìí wà",
    price: "Elo ni",
  },
  zulu: {
    greeting: "Sawubona",
    thanks: "Ngiyabonga",
    selfIntro: "Ngifunda isiZulu",
    need: "Ngifuna amanzi",
    confusion: "Angiqondi",
    repeat: "Ngicela uphinde",
    direction: "Ikuphi le ndawo",
    price: "Kubiza malini",
  },
  hausa: {
    greeting: "Sannu",
    thanks: "Na gode",
    selfIntro: "Ina koyon Hausa",
    need: "Ina son ruwa",
    confusion: "Ban gane ba",
    repeat: "Don Allah sake fada",
    direction: "Ina wannan wuri yake",
    price: "Nawa ne",
  },
  finnish: {
    greeting: "Hei",
    thanks: "Kiitos",
    selfIntro: "Opiskelen suomea",
    need: "Haluan vettä",
    confusion: "En ymmärrä",
    repeat: "Sano se uudelleen kiitos",
    direction: "Missä tämä paikka on",
    price: "Paljonko se maksaa",
  },
  hungarian: {
    greeting: "Szia",
    thanks: "Köszönöm",
    selfIntro: "Magyarul tanulok",
    need: "Vizet szeretnék",
    confusion: "Nem értem",
    repeat: "Kérem mondja újra",
    direction: "Hol van ez a hely",
    price: "Mennyibe kerül",
  },
  czech: {
    greeting: "Ahoj",
    thanks: "Děkuji",
    selfIntro: "Učím se česky",
    need: "Chci vodu",
    confusion: "Nerozumím",
    repeat: "Prosím zopakujte to",
    direction: "Kde je toto místo",
    price: "Kolik to stojí",
  },
  romanian: {
    greeting: "Salut",
    thanks: "Mulțumesc",
    selfIntro: "Învăț română",
    need: "Vreau apă",
    confusion: "Nu înțeleg",
    repeat: "Vă rog repetați",
    direction: "Unde este acest loc",
    price: "Cât costă",
  },
  serbian: {
    greeting: "Здраво",
    thanks: "Хвала",
    selfIntro: "Учим српски",
    need: "Желим воду",
    confusion: "Не разумем",
    repeat: "Молим вас поновите",
    direction: "Где је ово место",
    price: "Колико кошта",
  },
  croatian: {
    greeting: "Bok",
    thanks: "Hvala",
    selfIntro: "Učim hrvatski",
    need: "Želim vodu",
    confusion: "Ne razumijem",
    repeat: "Molim ponovite",
    direction: "Gdje je ovo mjesto",
    price: "Koliko košta",
  },
  irish: {
    greeting: "Dia duit",
    thanks: "Go raibh maith agat",
    selfIntro: "Táim ag foghlaim Gaeilge",
    need: "Ba mhaith liom uisce",
    confusion: "Ní thuigim",
    repeat: "Abair arís é le do thoil",
    direction: "Cá bhfuil an áit seo",
    price: "Cé mhéad atá air",
  },
  welsh: {
    greeting: "Helo",
    thanks: "Diolch",
    selfIntro: "Dw i'n dysgu Cymraeg",
    need: "Dw i eisiau dŵr",
    confusion: "Dw i ddim yn deall",
    repeat: "Dywedwch eto os gwelwch yn dda",
    direction: "Ble mae'r lle yma",
    price: "Faint yw e",
  },
  latin: {
    greeting: "Salve",
    thanks: "Gratias",
    selfIntro: "Linguam Latinam disco",
    need: "Aquam volo",
    confusion: "Non intellego",
    repeat: "Quaeso iterum dic",
    direction: "Ubi est hic locus",
    price: "Quanti constat",
  },
};
