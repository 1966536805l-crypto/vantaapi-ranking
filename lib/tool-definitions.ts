...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    shortTitle: "Audit",
    description: "Turn a public GitHub repository into a launch-readiness report in seconds",
    promise: "Score blockers issue drafts release checklist README env CI deploy security",
    ...
    whatItDoes: ["Reads public repo metadata and root setup files", "Scores release readiness and separates blockers from polish", "Creates GitHub issue drafts and a checklist for the work developers usually postpone"],
    ...
    outputExample: "Launch score blockers GitHub issue drafts README env CI deployment security and release checklist",
