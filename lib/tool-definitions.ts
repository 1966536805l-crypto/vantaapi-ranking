...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    shortTitle: "GitHub",
    description: "Analyze a public GitHub repository for setup steps tech stack structure and release risks",
    promise: "Repo overview run commands security notes deployment checklist and PR review checklist",
    inputHint: "Paste a public GitHub repository URL such as https://github.com/vercel/next.js",
    useCases: ["Understand a repository", "Prepare a contribution", "Check launch readiness"],
    whatItDoes: ["Reads public repo metadata and selected root files", "Summarizes setup commands structure and stack", "Flags release risks security notes and PR checks"],
    audience: ["Open source contributors", "Solo builders reviewing a dependency", "Developers preparing a launch checklist"],
    inputExample: "https://github.com/vercel/swr",
    outputExample: "Run commands security notes README upgrades CI suggestions deployment checklist and PR review checklist",
    limitations: ["Public repositories only", "Does not execute repository code", "Private repo support needs scoped auth and audit controls first"],
    faq: [
      ...
      { question: "Can it analyze private repos", answer: "Not in the MVP. Private repositories should stay out until explicit scoped auth and audit controls exist." },
    ],
  },
  {
