...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    promise: "Launch score risk level must fix list GitHub issues README env CI deployment SEO security and release steps",
    ...
    whatItDoes: ["Reads public repo metadata and selected root setup files", "Scores launch readiness and separates blockers from smaller warnings", "Builds copyable GitHub issues and a prelaunch checklist so you do not spend an hour finding boring release issues manually"],
    ...
    outputExample: "Launch score risk level must fix list copyable GitHub issues README env CI deploy SEO security and release steps",
