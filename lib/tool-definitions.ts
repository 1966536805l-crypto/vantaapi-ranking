...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    shortTitle: "Audit",
    description: "Check whether a public GitHub repository is ready to publish without reading every source file",
    promise: "README gaps env risks temporary files CI signals deployment checklist SEO basics security notes and release steps",
    inputHint: "Paste a public GitHub repository URL such as https://github.com/vercel/next.js",
    useCases: ["Check launch readiness", "Prepare a public release", "Create a repo handoff"],
    whatItDoes: ["Reads public repo metadata and selected root setup files", "Extracts commands environment signals CI presence deployment clues and documentation gaps", "Builds a copyable prelaunch checklist so you do not spend an hour finding boring release issues manually"],
    ...
    outputExample: "README fixes env checklist temp file warnings CI/deploy checklist SEO basics security notes and release steps",
    ...
    faq: [
      ...
      { question: "Why is this different from asking AI to read code", answer: "It focuses on the boring release work developers actually lose time on README gaps env files temporary artifacts CI deployment SEO basics and PR checklists." },
    ],
  },
  {
