...
export const toolDefinitions: ToolDefinition[] = [
  {
    ...
    shortTitle: "Audit",
    description: "Turn a public GitHub repository into a rules-first launch-readiness report",
    promise: "Deterministic checks score blockers issue drafts release checklist README env CI deploy security",
    inputHint: "Paste a public repo URL like https://github.com/vercel/next.js",
    useCases: ["Audit before launch", "Prepare a public release", "Hand off a repo"],
    whatItDoes: ["Reads public repo metadata and root setup files", "Uses deterministic checks before any AI-style wording", "Scores release readiness and separates blockers from polish", "Creates GitHub issue drafts and a checklist for the work developers usually postpone"],
    ...
    outputExample: "Rules-first launch score blockers GitHub issue drafts README env CI deployment security and release checklist",
    limitations: ["Public repositories only", "Does not execute or deeply analyze source code", "AI quality is not required for the core checks", "Private repo support needs scoped auth and audit controls first"],
    faq: [
      ...
      { question: "Does it depend on a strong AI model", answer: "No. The core product is rules first: README, env, CI, deploy, security, and release checks are deterministic. AI-style wording is only polish." },
      { question: "Why is this different from asking AI to read code", answer: "It focuses on launch chores that waste time: README gaps, env files, temporary artifacts, CI, deployment, security notes, and PR checklists." },
    ],
  },
  {
